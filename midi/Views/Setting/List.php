...
<title>Settings | Fanikiwa - Administrator</title>
...
<script src="/Scripts/ListSettings.js"></script>
...
<body>
	...
	<div id="body">
		...
		<section class="content-wrapper main-content clear-fix">
			...
			<div id="listSettingsResult">loading...</div>
	...
	<script type="text/javascript">
		function init() {
			fanikiwa.settingsendpoint.listsettings.init(GETROOT());
		}
	</script>
