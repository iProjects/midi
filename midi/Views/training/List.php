...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head id="header"  >
        ...
        <title>Training Programmes | Maasai Integrated Development Initiatives</title>
    ...
    <body id="frmmain">
                ...
                <div id="div-site-title">
                    ...
                    <div style="float: left; clear: both; position: relative; display: block;">
                        ...
                        <div id="divtitle">
                            ...
                            <span class="pagetitle">Maasai Integrated Development Initiatives - Training Programmes</span>
                ...
                <div id="body">
                    ...
                    <div class="content-wrapper main-content">
                        ...
                        <div class="divtabledisplay" style="float: left; clear: both; padding-top: 20px; height: auto !important; width: 100%;">
                            <div> <h2 class="page-title">Training Programmes [ 
                                    <?php
                                    $sql_select = "SELECT * FROM midi_training_programme";
                            ...
                            <div id="divtabledisplayassets" style="height: auto; width: 100%;">
                                ...
                                <div id="listTrainingsResult" style="clear: both; padding-bottom: 20px !important;">
                                    ...
                                    try {
                                        ...
                                        echo "<table id='listTrainingsTable'>";
                                        echo "<thead>";
                                        echo "<tr>";
                                        echo "<th>Id</th>";
                                        echo "<th>Type</th>";
                                        ...
                                        echo "<th>End Date</th>";
                                        echo "<th>Attendant Number</th>";
                                        echo "<th>Attendant Composition</th>";
                                        echo "<th>Topics</th>";
                                        echo "<th>Name Of Trainer</th>";
                                        echo "<th>Analysis</th>";
                                        echo "<th>Status</th>";
                                        echo "<th></th>";
                                        echo "<th></th>";
                                        ...
                                        if (count($trainings) > 0) {
                                            ...
                                            foreach ($trainings as $training) {
                                                echo "<tr>";
                                                echo "<td>" . $training['auto_id'] . "</td>";
                                                echo "<td>" . $training['tp_training_type'] . "</td>";
                                                echo "<td>" . $training['tp_training_start_date'] . "</td>";
                                                echo "<td>" . $training['tp_training_end_date'] . "</td>";
                                                echo "<td>" . $training['tp_attendant_number'] . "</td>";
                                                echo "<td>" . $training['tp_attendant_composition'] . "</td>";
                                                echo "<td>" . $training['tp_training_topics'] . "</td>";
                                                echo "<td>" . $training['tp_name_of_trainer'] . "</td>";
                                                echo "<td>" . $training['tp_training_analysis'] . "</td>";
                                                echo "<td>" . $training['tp_status'] . "</td>";
                                                echo '<td><a href="#" onclick="Edit(' . $training['auto_id'] . ')">Edit</a>';
                                                echo '<td><a href="#" onclick="Delete(' . $training['auto_id'] . ')">Delete</a>';
                                                echo "</tr>";
                                            }
                                        }
                                        echo "</tbody>";
                                ...
                                <form action="../../DAL/DeleteTraining.php" method="POST" id="form-delete-dialog">
        ...
        <script language="javascript" type="text/javascript">
            ...
            function CreateSubMenu() {
                ...
                SubMenu
                        .push('<li><a href="../../Views/training/Create.php" style="cursor: pointer;" title="Create">Create</a></li>');
                SubMenu.push('</ul></div>');
