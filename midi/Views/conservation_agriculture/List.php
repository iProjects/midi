...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head id="header"  >
        ...
        <title>Conservation Agriculture Programmes | Maasai Integrated Development Initiatives</title>
                ...
                <div id="div-site-title">
                    ...
                    <div style="float: left; clear: both; position: relative; display: block;">
                        ...
                        <div id="divtitle">
                            ...
                            <span class="pagetitle">Maasai Integrated Development Initiatives - Conservation Agriculture Programmes</span>
                ...
                <div id="body">
                    ...
                    <div class="content-wrapper main-content">
                        ...
                        <div class="divtabledisplay" style="float: left; clear: both; padding-top: 20px; height: auto !important; width: 100%;">
                            <div> <h2 class="page-title">Conservation Agriculture Programmes [ 
                                    <?php
                                    $sql_select = "SELECT * FROM midi_conservation_agriculture_programme";
                                    $stmt = $conn->query($sql_select);
                                    $conservation_agriculture_programmes = $stmt->fetchAll();
                                    echo count($conservation_agriculture_programmes);
                                    $stmt->closeCursor();
                                    ?> ]</h2></div>
                            <div id="divtabledisplayconservationagricultureprogrammes" style="height: auto; width: 100%;">

                                <div id="listConservationAgricultureProgrammesResult" style="clear: both; padding-bottom: 20px !important;">
                                    ...
                                    try {
                                        ...
                                        echo "<table id='listConservationAgricultureProgrammesTable'>";
                                        echo "<thead>";
                                        echo "<tr>";
                                        echo "<th>Id</th>";
                                        echo "<th>Demonstration Plot</th>";
                                        echo "<th>Crop Variety</th>";
                                        echo "<th>Group Name</th>";
                                        echo "<th>Group Population</th>";
                                        echo "<th>Initiation Date</th>";
                                        echo "<th>Completion Date</th>";
                                        echo "<th>Total Revenue Production</th>";
                                        echo "<th>Remarks</th>";
                                        echo "<th>Status</th>";
                                        echo "<th></th>";
                                        echo "<th></th>";
                                        ...
                                        if (count($conservation_agriculture_programmes) > 0) {

                                            foreach ($conservation_agriculture_programmes as $conservation_agriculture_programme) {
                                                echo "<tr>";
                                                echo "<td>" . $conservation_agriculture_programme['auto_id'] . "</td>";
                                                echo "<td>" . $conservation_agriculture_programme['cap_demonstration_plot'] . "</td>";
                                                echo "<td>" . $conservation_agriculture_programme['cap_crop_variety'] . "</td>";
                                                echo "<td>" . $conservation_agriculture_programme['cap_group_name'] . "</td>";
                                                echo "<td>" . $conservation_agriculture_programme['cap_group_population'] . "</td>";
                                                echo "<td>" . $conservation_agriculture_programme['cap_initiation_date'] . "</td>";
                                                echo "<td>" . $conservation_agriculture_programme['cap_completion_date'] . "</td>";
                                                echo "<td>" . $conservation_agriculture_programme['cap_total_revenue_production'] . "</td>";
                                                echo "<td>" . $conservation_agriculture_programme['cap_remarks'] . "</td>";
                                                echo "<td>" . $conservation_agriculture_programme['cap_status'] . "</td>";
                                                echo '<td><a href="#" onclick="Edit(' . $conservation_agriculture_programme['auto_id'] . ')">Edit</a>';
                                                echo '<td><a href="#" onclick="Delete(' . $conservation_agriculture_programme['auto_id'] . ')">Delete</a>';
                                                echo "</tr>";
                                            }
                                        }
                                        echo "</tbody>";
                                ...
                                <form action="../../DAL/DeleteConservationAgricultureProgramme.php" method="POST" id="form-delete-dialog">
        ...
        <script language="javascript" type="text/javascript">
            ...
            $(document).ready(function() {
                try {
                    ...
                    $('#listConservationAgricultureProgrammesTable').DataTable(
                            {
            ...
            function CreateSubMenu() {
                ...
                SubMenu
                        .push('<li><a href="../../Views/conservation_agriculture/Create.php" style="cursor: pointer;" title="Create">Create</a></li>');
                SubMenu.push('</ul></div>');
