...
<html lang="en">
    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            function postAjaxNow(user) {
                $.post("../DAL/Register.php", //Required URL of the page on server
                ...
                function (response, status) {
                    $('#apiResults').html('');
                    $('#errormessage').html('');
                    $('#successmessage').html('Operation successfull...<br/>' + "<br/>Response: " + response + "<br/>Status: " + status);
