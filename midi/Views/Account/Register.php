        ...
        <div id="body">
            ...
            <section class="content-wrapper main-content clear-fix">
                ...
                <div style="float: left; clear: both">
                    <input id="btnRegister" type="submit" value="Loading please wait..."
                           style="cursor: wait; background-color: grey; color: red;" disabled />
                    Already Registered Click<a  href="../../Views/Account/Login.php" class="button" > Here</a> To Login
                </div>
                ...
                <div style="float: left; clear: both;">
                    ...
                    <form id="form-register"  action="../../DAL/Register.php" method="post" enctype="multipart/form-data">
                        <fieldset>
