...
<title>Statement | Fanikiwa - Administrator</title>
...
<body>
	...
	<div id="body">
		...
		<section class="content-wrapper main-content clear-fix">
			...
			<hgroup class="title">
				<h2 class="page-title">Full Statement Details</h2>
			</hgroup>
			...
			<div id="statementheader" style="float: left; clear: both">
					...
					<div class="pad">
						...
						<div>
							<label for="dtpstartdate">Start Date*</label> <input
								id="dtpstartdate" placeholder="Start Date" type="date"
								style="width: 90%;"></input>
						</div>
				...
				<article class="col3">
					<div class="pad">
						...
						<div>
							<label for="dtpenddate">End Date*</label> <input id="dtpenddate"
								placeholder="End Date" type="date" style="width: 90%;"></input>
						</div>
	...
	<script type="text/javascript">
		function init() {
			fanikiwa.accountendpoint.statement.init(GETROOT());
		}
	</script>
