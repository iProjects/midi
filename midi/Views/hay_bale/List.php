...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head id="header"  >
        ...
        <title>Hay and Bale Programmes | Maasai Integrated Development Initiatives</title>
                ...
                <div id="div-site-title">
                    ...
                    <div style="float: left; clear: both; position: relative; display: block;">
                        ...
                        <div id="divtitle">
                            ...
                            <span class="pagetitle">Maasai Integrated Development Initiatives - Hay and Bale Programmes</span>
                ...
                <div id="body">
                    ...
                    <div class="content-wrapper main-content">
                        ...
                        <div class="divtabledisplay" style="float: left; clear: both; padding-top: 20px; height: auto !important; width: 100%;">
                            <div> <h2 class="page-title">Hay and Bale Programmes [ 
                                    <?php
                                    $sql_select = "SELECT * FROM midi_hay_bales_programme";
                                    $stmt = $conn->query($sql_select);
                                    $hay_bales_programmes = $stmt->fetchAll();
                                    echo count($hay_bales_programmes);
                                    $stmt->closeCursor();
                                    ?> ]</h2></div>
                            <div id="divtabledisplayhaybalesprogrammes" style="height: auto; width: 100%;">

                                <div id="listHayandBaleProgrammesResult" style="clear: both; padding-bottom: 20px !important;">
                                    ...
                                    try {
                                        ...
                                        echo "<table id='listHayandBaleProgrammesTable'>";
                                        echo "<thead>";
                                        echo "<tr>";
                                        echo "<th>Id</th>";
                                        echo "<th>Type</th>";
                                        echo "<th>Size</th>";
                                        echo "<th>Care Taker</th>";
                                        echo "<th>Date Planted</th>";
                                        echo "<th>Date Harvested</th>";
                                        echo "<th>Land Under Hay Capacity</th>";
                                        echo "<th>Training Offered</th>";
                                        echo "<th>Revenue</th>";
                                        echo "<th>Remarks</th>";
                                        echo "<th>Status</th>"; 
                                        echo "<th></th>";
                                        ...
                                        if (count($hay_bales_programmes) > 0) {

                                            foreach ($hay_bales_programmes as $hay_bales_programme) {
                                                echo "<tr>";
                                                echo "<td>" . $hay_bales_programme['auto_id'] . "</td>";
                                                echo "<td>" . $hay_bales_programme['hbp_hay_type'] . "</td>";
                                                echo "<td>" . $hay_bales_programme['hbp_hay_size'] . "</td>";
                                                echo "<td>" . $hay_bales_programme['hbp_hay_care_taker'] . "</td>";
                                                echo "<td>" . $hay_bales_programme['hbp_date_planted'] . "</td>";
                                                echo "<td>" . $hay_bales_programme['hbp_date_harvested'] . "</td>";
                                                echo "<td>" . $hay_bales_programme['hbp_land_under_hay_capacity'] . "</td>";
                                                echo "<td>" . $hay_bales_programme['hbp_training_offered'] . "</td>";
                                                echo "<td>" . $hay_bales_programme['hbp_revenue'] . "</td>";
                                                echo "<td>" . $hay_bales_programme['hbp_remarks'] . "</td>";
                                                echo "<td>" . $hay_bales_programme['hbp_status'] . "</td>";
                                                echo '<td><a href="#" onclick="Edit(' . $hay_bales_programme['auto_id'] . ')">Edit</a>';
                                                echo '<td><a href="#" onclick="Delete(' . $hay_bales_programme['auto_id'] . ')">Delete</a>';
                                                echo "</tr>";
                                            }
                                        }
                                        echo "</tbody>";
                                ...
                                <form action="../../DAL/DeleteHayandBaleProgrammes.php" method="POST" id="form-delete-dialog">
        ...
        <script language="javascript" type="text/javascript">
            ...
            $(document).ready(function () {
                try {
                    ...
                    $('#listHayandBaleProgrammesTable').DataTable(
                            {
            ...
            function CreateSubMenu() {
                ...
                SubMenu
                        .push('<li><a href="../../Views/hay_bale/Create.php" style="cursor: pointer;" title="Create">Create</a></li>');
                SubMenu.push('</ul></div>');
