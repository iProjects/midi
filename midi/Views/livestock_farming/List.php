...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head id="header"  >
        ...
        <title>Livestock Farming Programmes | Maasai Integrated Development Initiatives</title>
                ...
                <div id="div-site-title">
                    ...
                    <div style="float: left; clear: both; position: relative; display: block;">
                        ...
                        <div id="divtitle">
                            ...
                            <span class="pagetitle">Maasai Integrated Development Initiatives - Livestock Farming Programmes</span>
                ...
                <div id="body">
                    ...
                    <div class="content-wrapper main-content">
                        ...
                        <div class="divtabledisplay" style="float: left; clear: both; padding-top: 20px; height: auto !important; width: 100%;">
                            <div> <h2 class="page-title">Livestock Farming Programmes [ 
                                    <?php
                                    $sql_select = "SELECT * FROM midi_livestock_farming_programme";
                                    $stmt = $conn->query($sql_select);
                                    $livestock_farming_programmes = $stmt->fetchAll();
                                    echo count($livestock_farming_programmes);
                                    $stmt->closeCursor();
                                    ?> ]</h2></div>
                            <div id="divtabledisplaylivestockfarmingprogrammes" style="height: auto; width: 100%;">

                                <div id="listLivestockFarmingProgrammesResult" style="clear: both; padding-bottom: 20px !important;">
                                    ...
                                    try {
                                        ...
                                        echo "<table id='listLivestockFarmingProgrammesTable'>";
                                        echo "<thead>";
                                        echo "<tr>";
                                        echo "<th>Id</th>";
                                        echo "<th>Farm Location</th>";
                                        echo "<th>Breed Type</th>";
                                        echo "<th>Animal Id No</th>";
                                        echo "<th>Cost Of Animal</th>";
                                        echo "<th>Animal Date Of Birth</th>";
                                        echo "<th>Treatment</th>";
                                        echo "<th>Production Revenue</th>";
                                        echo "<th>Culling Date</th>";
                                        echo "<th>Remarks</th>";
                                        echo "<th>Status</th>"; 
                                        echo "<th></th>";
                                        echo "<th></th>";
                                        ...
                                        if (count($livestock_farming_programmes) > 0) {

                                            foreach ($livestock_farming_programmes as $livestock_farming_programme) {
                                                echo "<tr>";
                                                echo "<td>" . $livestock_farming_programme['auto_id'] . "</td>";
                                                echo "<td>" . $livestock_farming_programme['lfp_farm_location'] . "</td>";
                                                echo "<td>" . $livestock_farming_programme['lfp_breed_type'] . "</td>";
                                                echo "<td>" . $livestock_farming_programme['lfp_animal_id_no'] . "</td>";
                                                echo "<td>" . $livestock_farming_programme['lfp_cost_of_animal'] . "</td>";
                                                echo "<td>" . $livestock_farming_programme['lfp_animal_date_of_birth'] . "</td>";
                                                echo "<td>" . $livestock_farming_programme['lfp_treatment'] . "</td>";
                                                echo "<td>" . $livestock_farming_programme['lfp_animal_production_revenue'] . "</td>";
                                                echo "<td>" . $livestock_farming_programme['lfp_culling_date'] . "</td>";
                                                echo "<td>" . $livestock_farming_programme['lfp_remarks'] . "</td>";
                                                echo "<td>" . $livestock_farming_programme['lfp_status'] . "</td>";
                                                echo '<td><a href="#" onclick="Edit(' . $livestock_farming_programme['auto_id'] . ')">Edit</a>';
                                                echo '<td><a href="#" onclick="Delete(' . $livestock_farming_programme['auto_id'] . ')">Delete</a>';
                                                echo "</tr>";
                                            }
                                        }
                                        echo "</tbody>";
                                ...
                                <form action="../../DAL/DeleteLivestockFarmingProgrammes.php" method="POST" id="form-delete-dialog">
        ...
        <script language="javascript" type="text/javascript">
            ...
            $(document).ready(function () {
                try {
                    ...
                    $('#listLivestockFarmingProgrammesTable').DataTable(
                            {
            ...
            function CreateSubMenu() {
                ...
                SubMenu
                        .push('<li><a href="../../Views/livestock_farming/Create.php" style="cursor: pointer;" title="Create">Create</a></li>');
                SubMenu.push('</ul></div>');
