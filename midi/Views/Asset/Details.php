...
<title>Account Details | Fanikiwa - Administrator</title>
...
<script src="/Scripts/DetailAccounts.js"></script>
...
<body>
						...
						<div id="column-div" class="clearboth">
							...
							<article class="col1">
								<div class="pad">
									...
									<div>
										<label for="txtaccountID">ID</label> <input id="txtaccountID"
										   autofocus placeholder="ID" disabled type="number" min="0"></input>
									</div>
									...
									<div>
										<label for="txtbookBalance">Book Balance</label> <input
									...
									<div>
										<label for="txtlimit">Limit</label> <input id="txtlimit"
											placeholder="Limit" type="number" min="0" disabled></input>
									</div>
									...
									<div>
										<label for="txtcustomer">Customer</label> <input
											id="txtcustomer" placeholder="Customer" type="number" min="0"
											disabled></input>
									</div>

									<div>
										<label for="cbocoadet">Chart Of Account</label> <select
											id="cbocoadet" style="width: 95%;" disabled>
									...
									<div>
										<label for="cboaccounttype">Account Type</label> <select
											id="cboaccounttype" style="width: 95%;" disabled>
									...
									<div>
										<label for="cbopassFlag">Pass Flag</label><select
											id="cbopassFlag" style="width: 95%;" disabled>
									...
									<div>
										<label for="cbolimitFlag">Limit Flag</label><select
											id="cbolimitFlag" style="width: 95%;" disabled>
								...
								<div class="pad">
									...
									<div>
										<label for="txtinterestRateSusp">Interest Rate In
											...
											placeholder="Interest Rate In Suspense" type="number" min="0"
											disabled></input>
									</div>
									...
									<div>
										<label for="txtlimitCheckFlag">Limit Check Flag</label> <input
											...
											type="number" min="0" max="1" disabled></input>
									</div>
								...
								<div class="pad">
									...
									<div>
										<label for="dtpmaturityDate">Maturity Date</label> <input
											id="dtpmaturityDate" placeholder="Maturity Date" type="date" disabled ></input>
									</div>

									<div>
										<label for="dtplastIntAccrualDate">Last Interest
											Accrual Date</label> <input id="dtplastIntAccrualDate"
											placeholder="Last Interest Accrual Date" type="date" disabled ></input>
									</div>

									<div>
										<label for="dtpnextIntAccrualDate">Next Interest
											Accrual Date</label> <input id="dtpnextIntAccrualDate"
											placeholder="Next Interest Accrual Date" type="date" disabled ></input>
									</div>

									<div>
										<label for="dtplastIntAppDate">Last Interest
											Application Date</label> <input id="dtplastIntAppDate"
											placeholder="Last Interest Application Date" type="date" disabled ></input>
									</div>

									<div>
										<label for="dtpnextIntAppDate">Next Interest
											Application Date</label> <input id="dtpnextIntAppDate"
											placeholder="Next Interest Application Date" type="date" disabled ></input>
									</div>

									<div>
										<label for="txtbranch">Branch</label> <input disabled
											id="txtbranch" placeholder="Branch" type="text" disabled></input>
									</div>
									...
									<div>
										<label for="chkclosed">Closed</label> <input id="chkclosed"
											placeholder="Closed" type="checkbox" disabled></input>
									</div>
	...
	function init() {
		fanikiwa.accountendpoint.accountdetails.init(GETROOT());
	}
</script>
