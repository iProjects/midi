...
<title>CoA Details | Fanikiwa - Administrator</title>
...
<script src="/Scripts/ListCoaDet.js"></script>
...
<body>
	...
	<div id="body">
		...
		<section class="content-wrapper main-content clear-fix">
			...
			<hgroup class="title">
				<h2 class="page-title">Chart Of Accounts Details</h2>
			</hgroup>
			...
			<div id="listCoaDetResult">loading...</div>
	...
	<script type="text/javascript">
		function init() {
			fanikiwa.coadetendpoint.listcoadet.init(GETROOT());
		}
	</script>
