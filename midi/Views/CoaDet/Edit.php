...
<title>Edit CoA Detail | Fanikiwa - Administrator</title>
...
<script src="/Scripts/EditCoaDet.js"></script>
...
<body>
	...
	<div id="body">
		...
		<section class="content-wrapper main-content clear-fix">
			...
			<hgroup class="title">
				<h2 class="page-title">Edit Chart Of Account Detail</h2>
			</hgroup>
			...
			<div style="float: left; clear: both">
				...
				<form action="javascript:void(0);">
					...
					<fieldset>
						<legend>Edit Chart Of Account Detail</legend>
	...
	function init() {
		fanikiwa.coadetendpoint.editcoadet.init(GETROOT());
	}
</script>
