...
<title>Organizations | Fanikiwa - Administrator</title>
...
<script src="/Scripts/ListOrganization.js"></script>
...
<body>
	...
	<div id="body">
		...
		<section class="content-wrapper main-content clear-fix">
			...
			<div id="listOrganizationsResult" style="clear: both">loading...</div>
	...
	<script type="text/javascript">
		function init() {
			fanikiwa.organizationendpoint.listorganizations.init(GETROOT());
		}
	</script>
