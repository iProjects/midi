...
<title>Create Transaction Type | Fanikiwa - Administrator</title>
...
<script src="/Scripts/CreateTransactionType.js"></script>
...
<body>
	...
	function init() {
		fanikiwa.transactiontypeendpoint.createtransactiontype.init(GETROOT());
	}
