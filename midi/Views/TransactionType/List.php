...
<title>Transaction Types | Fanikiwa - Administrator</title>
...
<script src="/Scripts/ListTransactionTypes.js"></script>
...
<body>
	...
	<div id="body">
		...
		<section class="content-wrapper main-content clear-fix">
			...
			<hgroup class="title">
				<h2 class="page-title">Transaction Types</h2>
			</hgroup>
			...
			<div id="listTransactionTypesResult">loading...</div>
	...
	<script type="text/javascript">
		function init() {
			fanikiwa.transactiontypeendpoint.listtransactiontypes.init(GETROOT());
		}
	</script>
