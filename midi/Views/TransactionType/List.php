...
<html lang="en">
    ...
    <head>
        ...
        <title>Transaction Types | Maasai Integrated Development Initiatives</title>
    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            function CreateSubMenu() {
                ...
                SubMenu
                        .push('<li><div class="floatleft"><div><a href="../../Views/TransactionType/Create.php" style="cursor: pointer;" >Create</a></div></div></li>');
                SubMenu.push('</ul></div>');
