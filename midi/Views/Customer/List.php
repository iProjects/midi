...
<html lang="en">
    ...
    <head>
        ...
        <title>Customers | Maasai Integrated Development Initiatives</title>
    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            function CreateSubMenu() {
                ...
                SubMenu
                        .push('<li><div class="floatleft"><div><a href="../../Views/Customer/Create.php" style="cursor: pointer;" >Create</a></div></div></li>');
                SubMenu.push('</ul></div>');
