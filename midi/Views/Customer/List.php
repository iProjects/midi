...
<title>Customers | Fanikiwa - Administrator</title>
...
<script src="/Scripts/ListCustomer.js"></script>
...
<body>
	...
	<div id="body">
		...
		<section class="content-wrapper main-content clear-fix">
			...
			<div id="listCustomersResult">loading...</div>
	...
	<script type="text/javascript">
		function init() {
			fanikiwa.customerendpoint.listcustomers.init(GETROOT());
		}
	</script>
