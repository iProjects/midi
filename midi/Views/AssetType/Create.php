...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head id="header"  >
        ...
        <title>Create Asset Type | Hotel Reservation Management System</title>
                ...
                <div id="div-site-title">
                    ...
                    <div style="float: left; clear: both; position: relative; display: block;">
                        ...
                        <div id="divlogo">
                            ...
                            <img id="logo" alt="Hotel Reservation Management System" src="../../Images/logo.jpg"   style="clear: both; float: left;" title="Hotel Reservation Management System" />

                        </div>

                        <div id="divtitle">

                            <span class="pagetitle">Hotel Reservation Management System - Create Asset Type</span>
                ...
                <div id="body">
                    ...
                    <div class="content-wrapper main-content">
                        ...
                        <div style="clear: both;float: left;">
                            ...
                            <form id="wizard" action="../../DAL/CreateAssetType.php" method="POST"  enctype="multipart/form-data">
                                        ...
                                        <div class="divcol1">
                                            ...
                                            <div class="divinput">
                                                ...
                                                try {
                                                    //establish database connection. Should be called once in a page.                                                    
                                                    //include ("../../DAL/MySqlConnection.php");
//                                                    $sql_select = "SELECT * FROM hrms_roles where status in ('Y')";
//                                                    $stmt = $conn->query($sql_select);
//                                                    $roles = $stmt->fetchAll();
//
...
//                                                    
        ...
        <script language="javascript" type="text/javascript">
            ...
            function CreateMainMenu() {
                ...
                MainMenu
                        .push('<li><a href="../../Views/AssetType/List.php" style="cursor: pointer;" title="Asset Types">Asset Types</a></li>');
                MainMenu
