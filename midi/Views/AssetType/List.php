...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head id="header">
        ...
        <title>Asset Types | Maasai Integrated Development Initiatives</title>
    ...
    <body id="frmmain">
                ...
                <div id="div-site-title">
                    ...
                    <div style="float: left; clear: both; position: relative; display: block;">
                        ...
                        <div id="divtitle">
                            ...
                            <span class="pagetitle">Maasai Integrated Development Initiatives - Asset Types</span>
                ...
                <div id="body">
                    ...
                    <div class="content-wrapper main-content">
                        ...
                        <div class="divtabledisplay" style="float: left; clear: both; padding-top: 20px; height: auto !important; width: 100%;">
                            <div> <h2 class="page-title">Asset Types[ 
                                    <?php
                                    $sql_select = "SELECT * FROM midi_asset_types";
                                    $stmt = $conn->query($sql_select);
                                    $asset_types = $stmt->fetchAll();
                                    echo count($asset_types);
                                    $stmt->closeCursor();
                                    ?> ]</h2></div>
                            <div id="divtabledisplayassettypes" style="height: auto; width: 100%;">

                                <div id="listAssetTypesResult" style="clear: both; padding-bottom: 20px !important;">
                                    ...
                                    try {
                                        ...
                                        echo "<table id='listAssetTypesTable'>";
                                        echo "<thead>";
                                        echo "<tr>";
                                        echo "<th>Id</th>"; 
                                        ...
                                        if (count($asset_types) > 0) {
                                            ...
                                            foreach ($asset_types as $asset_type) {
                                                echo "<tr>";
                                                echo "<td>" . $asset_type['auto_id'] . "</td>";
                                                echo "<td>" . $asset_type['at_description'] . "</td>";
                                                echo "<td>" . $asset_type['at_status'] . "</td>"; 
                                                echo '<td><a href="#" onclick="Edit(' . $asset_type['auto_id'] . ')">Edit</a>';
                                                echo '<td><a href="#" onclick="Delete(' . $asset_type['auto_id'] . ')">Delete</a>';
                                                echo "</tr>";
                                            }
                                        }
                                        echo "</tbody>";
                                ...
                                <form action="../../DAL/DeleteAssetType.php" method="POST" id="form-delete-dialog">
        ...
        <script language="javascript" type="text/javascript">
            ...
            function CreateSubMenu() {
                ...
                SubMenu
                        .push('<li><a href="../../Views/AssetType/Create.php" style="cursor: pointer;" title="Create">Create</a></li>');
                SubMenu.push('</ul></div>');
