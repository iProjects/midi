...
<title>Edit Chart of Account | Fanikiwa - Administrator</title>
...
<script src="/Scripts/EditCoa.js"></script>
...
<body>
	...
	<div id="body">
		...
		<section class="content-wrapper main-content clear-fix">
			...
			<hgroup class="title">
				<h2 class="page-title">Edit Chart Of Account</h2>
			</hgroup>
			...
			<div style="float: left; clear: both">
				...
				<form action="javascript:void(0);">
					...
					<fieldset>
						<legend>Edit Chart Of Account</legend>
								...
								<div class="pad">
									...
									<div>
										<label for="txtid">ID</label> <input id="txtid"
											placeholder="ID" type="number" min="0" disabled></input>
									</div>
	...
	function init() {
		fanikiwa.coaendpoint.editcoa.init(GETROOT());
	}
</script>
